...
- **Pre-1974 (14 volumes)** — parked under `sources/gpp/volumes/`; per-order splitting (local VLM OCR + index segmentation) is Phase E, not done here — `scripts/run_volume_ocr.py` then `scripts/run_pre1974_build.py`, reported in `pre1974_report.md`.
